...
public class CardPresenter extends Presenter {
    ...
    public static void updateCardBackgroundColor(ImageCardView view, boolean selected)
    {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item)
    {
        ...
        if (movie.getCardImageUrl() != null)
        {
            ...
            Glide.with(viewHolder.view.getContext()).load(movie.getCardImageUrl()).centerCrop().into(cardView.getMainImageView());
        }
    }
